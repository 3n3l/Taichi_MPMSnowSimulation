...
class HydrodynamicModel:
    def __init__(
        ...
        ### New parameters ====================================================
        self.p_initial_position = ti.field(dtype=float, shape=self.n_particles)
        self.p_initial_velocity = ti.field(dtype=float, shape=self.n_particles)
        ...
        # self.p_initial_phase.from_numpy(initial_phase)
...
def main():
    ...
    simulation = HydrodynamicModel(quality=quality, n_particles=n_particles)
    simulation.run()
