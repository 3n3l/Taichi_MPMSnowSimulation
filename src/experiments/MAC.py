...
u = ti.field(dtype=float, shape=(nx+1,ny+2))            # Node velocity, x components
v = ti.field(dtype=float, shape=(nx+2,ny+1))            # Node velocity, y components
p  = ti.field(dtype=float, shape=(nx+2,ny+2))           # Pressure
