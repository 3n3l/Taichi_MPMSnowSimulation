...
def main():
    ...
    mpm = MPM(
        ...
        initial_positions=np.array([[0.05, 0.595], [0.93, 0.615]], dtype=np.float32),
        initial_velocities=np.array([[5, 0], [-3, 0]], dtype=np.float32),
        initial_radii=np.array([0.04, 0.05], dtype=np.float32),
    )
    mpm.run()
